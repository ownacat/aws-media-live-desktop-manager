...
export default function CalculateFolderSize({path}: {path: string}) {
  ...
  switch(state){
    case STATE_EMPTY: 
      return <Button.Secondary className="px-0 py-0 mr-0 mb-0" onClick={calucate}>Calculate</Button.Secondary>;

    case STATE_LOADING: 
      return <Button.Secondary onClick={() => {}} className="px-0 py-0 mr-0 mb-0" disabled loading>Calculate</Button.Secondary>;
